            ...
            // Block local/internal URLs to prevent SSRF
              try {
                ...
                if (parsed.protocol !== 'http:' && parsed.protocol !== 'https:') {
                  return { content: [{ type: 'text', text: 'Only http and https URLs are supported.' }], isError: true } as any;
                }
                ...
                if (host === 'localhost' || host === '127.0.0.1' || host === '[::1]' || host === '0.0.0.0'
                  ...
                  return { content: [{ type: 'text', text: 'Fetching local/internal URLs is not allowed.' }], isError: true } as any;
                }
              } catch {
                return { content: [{ type: 'text', text: 'Invalid URL.' }], isError: true } as any;
              }
