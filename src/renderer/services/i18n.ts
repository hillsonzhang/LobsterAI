...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    shortcuts: '快捷键',
    envVars: '环境变量',
    envVarsDesc: '配置自定义环境变量，将注入所有技能脚本和工具进程',
    envVarsImport: '导入 JSON',
    envVarsExport: '导出',
    envVarsAdd: '添加',
    envVarsKey: '变量名',
    envVarsValue: '变量值',
    envVarsEmpty: '暂无自定义环境变量',
    envVarsImportSuccess: '导入成功：{env} 个环境变量，{providers} 个模型配置',
    envVarsImportFailed: '导入失败',
    about: '关于',
    aboutVersion: '版本',
    ...
    coworkWorkingDirectoryHint: 'SD Agent 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 SD Agent 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 SD Agent 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'SD Agent 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkPermissionDescription: 'SD Agent 请求执行以下操作',
    coworkToolName: '工具名称',
    ...
    forceUpdateMessage: '检测到新版本，当前版本已不可用，请立即下载更新。',
    ...
    knowledgeBaseUploadFormats: '支持 PDF、Markdown、TXT 格式',
    knowledgeBaseLoading: '加载中...',
    ...
    knowledgeBaseSidecarRestart: '重启服务',
    knowledgeBaseSidecarRestarting: '重启中...',
    knowledgeBaseView: '查看',
    knowledgeBaseNodes: '{count} 个节点',
    knowledgeBaseEmbedConfig: 'Embedding 配置',
    knowledgeBaseEmbedApiBase: 'API Base URL',
    knowledgeBaseEmbedApiBasePlaceholder: 'https://api.openai.com/v1',
    knowledgeBaseEmbedApiKey: 'API Key',
    knowledgeBaseEmbedApiKeyPlaceholder: '输入 Embedding API Key',
    knowledgeBaseEmbedModel: '模型',
    knowledgeBaseEmbedModelPlaceholder: 'text-embedding-3-small',
    knowledgeBaseEmbedDim: '维度',
    knowledgeBaseEmbedTest: '测试连接',
    knowledgeBaseEmbedTestSuccess: '连接成功',
    knowledgeBaseEmbedTestFail: '连接失败',
    knowledgeBaseEmbedSave: '保存配置',
    knowledgeBaseEmbedSaving: '保存中...',
    knowledgeBaseEmbedSaved: '已保存',
    knowledgeBaseEmbedTesting: '测试中...',
    knowledgeBaseLlmConfig: 'LLM 配置',
    knowledgeBaseLlmApiBase: 'API Base URL',
    knowledgeBaseLlmApiBasePlaceholder: 'https://api.openai.com/v1',
    knowledgeBaseLlmApiKey: 'API Key',
    knowledgeBaseLlmApiKeyPlaceholder: '输入 LLM API Key',
    knowledgeBaseLlmModel: '模型',
    knowledgeBaseLlmModelPlaceholder: 'gpt-4o-mini',
    knowledgeBaseLlmTest: '测试连接',
    knowledgeBaseLlmTestSuccess: '连接成功',
    knowledgeBaseLlmTestFail: '连接失败',
    knowledgeBaseLlmSave: '保存配置',
    knowledgeBaseLlmSaving: '保存中...',
    knowledgeBaseLlmSaved: '已保存',
    knowledgeBaseLlmTesting: '测试中...',
    knowledgeBaseLlmRequired: 'LLM 配置是知识库索引和深度搜索的必要条件，请配置后使用。',
    knowledgeBaseRerankerConfig: 'Reranker 配置（可选）',
    knowledgeBaseRerankerEnabled: '启用 Reranker',
    knowledgeBaseRerankerApiBase: 'API Base URL',
    knowledgeBaseRerankerApiBasePlaceholder: 'https://api.jina.ai/v1',
    knowledgeBaseRerankerApiKey: 'API Key',
    knowledgeBaseRerankerModel: '模型',
    knowledgeBaseRerankerModelPlaceholder: 'jina-reranker-v2-base-multilingual',
    knowledgeBaseRerankerSave: '保存配置',
    knowledgeBaseRerankerSaving: '保存中...',
    knowledgeBaseRerankerSaved: '已保存',
    searchSkills: '搜索技能',
    manageSkills: '管理技能',
    officialSkills: '官方技能',
    addSkill: '添加',
  ...
  en: {
    ...
    envVarsDesc: 'Configure custom environment variables injected into all skill scripts and tool processes',
    envVarsImport: 'Import JSON',
    envVarsExport: 'Export',
    envVarsAdd: 'Add',
    envVarsKey: 'Key',
    envVarsValue: 'Value',
    envVarsEmpty: 'No custom environment variables',
    envVarsImportSuccess: 'Imported: {env} env vars, {providers} provider configs',
    envVarsImportFailed: 'Import failed',
    about: 'About',
    ...
    coworkSettings: 'SD Agent Settings',
    ...
    coworkWorkingDirectoryHint: 'SD Agent will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for SD Agent...',
    coworkSystemPromptHint: 'Optional system prompt to customize SD Agent\'s behavior',
    ...
    coworkModelSettingsHint: 'SD Agent uses the current model and provider configuration from Model Settings.',
    ...
    coworkPermissionDescription: 'SD Agent is requesting to perform the following action',
    ...
    forceUpdateMessage: 'A new version is required. Your current version is no longer supported. Please download the update now.',
    ...
    knowledgeBaseUploadFormats: 'Supports PDF, Markdown, and TXT',
    ...
    knowledgeBaseRetryIndex: 'Retry Index',
    ...
    knowledgeBaseSidecarRestart: 'Restart Service',
    knowledgeBaseSidecarRestarting: 'Restarting...',
    knowledgeBaseView: 'View',
    knowledgeBaseNodes: '{count} nodes',
    knowledgeBaseEmbedConfig: 'Embedding Configuration',
    knowledgeBaseEmbedApiBase: 'API Base URL',
    knowledgeBaseEmbedApiBasePlaceholder: 'https://api.openai.com/v1',
    knowledgeBaseEmbedApiKey: 'API Key',
    knowledgeBaseEmbedApiKeyPlaceholder: 'Enter Embedding API Key',
    knowledgeBaseEmbedModel: 'Model',
    knowledgeBaseEmbedModelPlaceholder: 'text-embedding-3-small',
    knowledgeBaseEmbedDim: 'Dimensions',
    knowledgeBaseEmbedTest: 'Test Connection',
    knowledgeBaseEmbedTestSuccess: 'Connection successful',
    knowledgeBaseEmbedTestFail: 'Connection failed',
    knowledgeBaseEmbedSave: 'Save',
    knowledgeBaseEmbedSaving: 'Saving...',
    knowledgeBaseEmbedSaved: 'Saved',
    knowledgeBaseEmbedTesting: 'Testing...',
    knowledgeBaseLlmConfig: 'LLM Configuration',
    knowledgeBaseLlmApiBase: 'API Base URL',
    knowledgeBaseLlmApiBasePlaceholder: 'https://api.openai.com/v1',
    knowledgeBaseLlmApiKey: 'API Key',
    knowledgeBaseLlmApiKeyPlaceholder: 'Enter LLM API Key',
    knowledgeBaseLlmModel: 'Model',
    knowledgeBaseLlmModelPlaceholder: 'gpt-4o-mini',
    knowledgeBaseLlmTest: 'Test Connection',
    knowledgeBaseLlmTestSuccess: 'Connection successful',
    knowledgeBaseLlmTestFail: 'Connection failed',
    knowledgeBaseLlmSave: 'Save',
    knowledgeBaseLlmSaving: 'Saving...',
    knowledgeBaseLlmSaved: 'Saved',
    knowledgeBaseLlmTesting: 'Testing...',
    knowledgeBaseLlmRequired: 'LLM configuration is required for indexing and deep search. Please configure it first.',
    knowledgeBaseRerankerConfig: 'Reranker Configuration (Optional)',
    knowledgeBaseRerankerEnabled: 'Enable Reranker',
    knowledgeBaseRerankerApiBase: 'API Base URL',
    knowledgeBaseRerankerApiBasePlaceholder: 'https://api.jina.ai/v1',
    knowledgeBaseRerankerApiKey: 'API Key',
    knowledgeBaseRerankerModel: 'Model',
    knowledgeBaseRerankerModelPlaceholder: 'jina-reranker-v2-base-multilingual',
    knowledgeBaseRerankerSave: 'Save',
    knowledgeBaseRerankerSaving: 'Saving...',
    knowledgeBaseRerankerSaved: 'Saved',
