...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    migrateData: '数据迁移',
    migrateDataDescription: '从旧版 LobsterAI 目录导入对话记录和配置数据。已存在的同名文件会自动备份。迁移成功后应用会自动重启。',
  ...
  en: {
    ...
    migrateDataDescription: 'Import conversations and configuration from the legacy LobsterAI directory. Existing files will be backed up automatically. The app will restart after migration.',
