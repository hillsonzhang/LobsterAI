...
const McpServerFormModal: React.FC<McpServerFormModalProps> = ({
  ...
  const inputClass = 'w-full px-3 py-2 text-sm rounded-xl bg-claude-bg text-claude-text placeholder-claude-textSecondary border border-claude-border focus:outline-none focus:ring-2 focus:ring-claude-accent';
  const readOnlyInputClass = inputClass + ' opacity-60 cursor-not-allowed';
  const labelClass = 'text-xs font-semibold tracking-wide text-claude-textSecondary';
  const kvInputClass = 'flex-1 px-2 py-1.5 text-sm rounded-lg bg-claude-bg text-claude-text border border-claude-border focus:outline-none focus:ring-1 focus:ring-claude-accent';
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg mx-4 rounded-2xl bg-claude-surface border border-claude-border shadow-2xl p-6 max-h-[80vh] overflow-y-auto"
        ...
        <div className="space-y-4">
                  ...
                  <div key={index} className="flex items-center gap-2">
                    ...
                    {!row.required && (
                      <button
                        ...
                        className="p-1 text-claude-textSecondary hover:text-red-500 dark:hover:text-red-400 transition-colors flex-shrink-0"
                      >
          ...
          <div className="flex items-center justify-end gap-2 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="px-3 py-1.5 text-xs rounded-lg border border-claude-border text-claude-textSecondary hover:bg-claude-surfaceHover transition-colors"
            >
