    ...
    >
          ...
          <div className={`flex items-center mb-1 ${showStatusIndicator ? 'gap-2' : 'gap-0'}`}>
            ...
            {isRenaming ? (
              <input
                ...
                className="flex-1 min-w-0 rounded-lg border border-claude-border bg-claude-bg px-2 py-1 text-sm font-medium text-claude-text focus:outline-none focus:ring-2 focus:ring-claude-accent"
              />
            ) : (
      ...
      >
        <button
          ref={actionButtonRef}
          onClick={openMenu}
          className="p-1.5 rounded-lg bg-claude-surfaceMuted text-claude-textSecondary hover:bg-claude-surface transition-colors"
      ...
      {menuPosition && (
        <div
          ref={menuRef}
          className="fixed z-50 min-w-[180px] rounded-xl border border-claude-border bg-claude-surface shadow-lg overflow-hidden"
            ...
            <button
              ...
              className={`w-full flex items-center gap-2 px-3 py-2 text-left text-sm transition-colors ${
                item.tone === 'danger'
                  ...
                  : 'text-claude-text hover:bg-claude-surfaceHover'
              }`}
            >
