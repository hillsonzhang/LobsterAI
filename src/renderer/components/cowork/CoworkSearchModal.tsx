...
const CoworkSearchModal: React.FC<CoworkSearchModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="modal-content w-full max-w-2xl mt-10 rounded-2xl border border-claude-border bg-claude-surface shadow-modal overflow-hidden"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className="px-3 py-3 max-h-[60vh] overflow-y-auto">
          {filteredSessions.length === 0 ? (
            <div className="py-10 text-center text-sm text-claude-textSecondary">
