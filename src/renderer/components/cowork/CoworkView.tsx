  ...
  if (!isInitialized) {
    return (
      <div className="flex-1 h-full flex flex-col bg-claude-bg">
        <div className="draggable flex h-12 items-center justify-end px-4 border-b border-claude-border shrink-0">
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        <div className="max-w-3xl mx-auto px-4 py-16 space-y-12">
          ...
          <div className="text-center space-y-5">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-claude-text">
              {i18nService.t('coworkWelcome')}
            </h2>
            <p className="text-sm text-claude-textSecondary max-w-md mx-auto">
